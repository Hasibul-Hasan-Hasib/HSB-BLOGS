    ...
    return (
        <div className="flex items-center flex-col justify-center lg:flex-row py-28 px-6 md:px-24 md:py-20 lg:py-32 gap-16 lg:gap-28">
            <div className="w-full lg:w-1/2">
                ...
                <img className="hidden md:block lg:hidden mx-auto" src="https://i.ibb.co/c1ggfn2/Group-193.png" alt="" />
                <img className="md:hidden mx-auto" src="https://i.ibb.co/8gTVH2Y/Group-198.png" alt="" />
            </div>
            <div className="w-full lg:w-1/2">
